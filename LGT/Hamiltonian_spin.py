...
def Hamiltonian_spin(x, y, m, r, a, g, C):
        
# =============================================================================
# mass term
# =============================================================================
       
    H_m = Make_mass(x, y, r, m, a, C)
...
# =============================================================================
    ...
    H_Tx = Make_momentum_x(C, x, y, a, r)
...
# =============================================================================
    ...
    H_Ty = Make_momentum_y(C, x, y, a, r)
