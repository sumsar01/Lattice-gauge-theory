...
#psi = tensor(basis(2, 0), basis(2, 1), basis(2, 0), basis(2, 1),basis(2, 0), basis(2, 1), basis(2, 0), basis(2, 1),basis(2, 1), basis(2, 0), basis(2, 0), basis(2, 1), basis(2, 1), basis(2, 0),basis(2, 1), basis(2, 0))
#psi = tensor(basis(2, 0), basis(2, 1),     basis(2, 0), basis(2, 1),    basis(2, 0), basis(2, 1),    basis(2, 0), basis(2, 1), 
#             basis(2, 1), basis(2, 0),     basis(2, 0), basis(2, 1),    basis(2, 0), basis(2, 1),    basis(2, 1), basis(2, 0))
...
while i < num_t:
    states = psi[i]
    pos_00.append(expect(num_ope_site(x, y, 0, 0),states))
    ...
    total.append(expect(Wilson_loop(x, y, i, j),states))#expect(num_ope(x, y),states))
    i += 1
